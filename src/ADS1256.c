...
*	parameter: _ucScanMode : 0  Single-ended input  8 channel£¬ 1 Differential input  4 channe
*	The return value: NULL
*********************************************************************************************************
*/
...
void ADS1256_CfgADC(ADS1256_GAIN_E _gain, ADS1256_DRATE_E _drate)
{
...

	{
		...
		*/
		...
		CS_0();	/* SPIÆ¬Ñ¡ = 0 */
		ADS1256_Send8Bit(CMD_WREG | 0);	/* Write to register, send the register address */
		ADS1256_Send8Bit(0x03);			/* 4 bytes written, -1*/
...
{
	CS_0();	/* SPI  cs  = 0 */
	ADS1256_Send8Bit(CMD_WREG | _RegID);	/*Write to register _RegID */
	ADS1256_Send8Bit(0x00);		/*Write 1 byte, -1 */
...
{
	if (g_tADS1256.ScanMode == SINGLE)	/*  0  Single-ended input  8 channel£¬ 1 Differential input  4 channe */
	{
